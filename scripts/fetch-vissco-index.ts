 ...
 *
 * Writes data/reference/vissco-index.json. Vissco runs WooCommerce, whose Store
...
const BASE = "https://www.vissco.com/wp-json/wc/store/v1/products";
const PER_PAGE = 100;
const UA =
...
async function main() {
  ...
  const out = path.join(dir, "vissco-index.json");
